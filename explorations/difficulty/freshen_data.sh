...
cat store/difficulty-014000000-014999999.txt >>store/difficulty.csv ; echo "15000000"
cat store/difficulty-015000000-015999999.txt >>store/difficulty.csv
#; echo "projected"
...
echo -n " "
tail -1 store/difficulty-015000000-015999999.txt
